                    ...
                    <ul class="navbar-nav ml-auto">
                      ...
                      <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="{{url('showcart')}}"><i
                                        class="fas fa-shopping-cart">Košarica[{{ isset($count) ? $count : 0
        ...
        <table>
            ...
            <form action="{{url('order')}}" method="POST">
                ...
                <tr style="color:black;">
                    ...
                    <td style="padding:10px;"><a class="btn btn-danger"
                            href="{{url('delete',$carts->id)}}">Ukloni</a></td>
